  ...
  return (
    <div className="w-full">
      <div className="bg-brand-darkBlue py-20 text-center text-white">
        <h1 className="text-4xl md:text-5xl font-black mb-4">Sobre JUMAX</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             <div className="text-center p-6 bg-slate-50 rounded-xl">
               ...
               <h3 className="font-bold text-xl mb-2">Experiencia</h3>
               <p className="text-slate-500 text-sm">Años sirviendo a familias y negocios en Reynosa.</p>
             </div>
             <div className="text-center p-6 bg-slate-50 rounded-xl">
               <div className="bg-brand-blue/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-brand-blue">
                 <Award size={32} />
               ...
               <p className="text-slate-500 text-sm">Utilizamos materiales de primera y herramientas especializadas.</p>
             </div>
             <div className="text-center p-6 bg-slate-50 rounded-xl">
               <div className="bg-brand-blue/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-brand-blue">
                 <Star size={32} />
               </div>
               <h3 className="font-bold text-xl mb-2">Honestidad</h3>
               <p className="text-slate-500 text-sm">Cobros justos y transparentes desde el principio.</p>
             </div>
           </div>
        </div>
      </section>
