...
const Privacy: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-heading font-bold mb-8">Aviso de Privacidad</h1>
      <div className="prose prose-slate">
        ...
        <h2 className="text-xl font-heading font-bold mt-6 mb-2">Recopilación de Información</h2>
        <p className="mb-4 text-lg">
        ...
        <h2 className="text-xl font-heading font-bold mt-6 mb-2">Uso de la Información</h2>
        <p className="mb-4 text-lg">
        ...
        <h2 className="text-xl font-heading font-bold mt-6 mb-2">Protección de Datos</h2>
        <p className="mb-4 text-lg">
        ...
        <h2 className="text-xl font-heading font-bold mt-6 mb-2">Contacto</h2>
        <p className="text-lg">
