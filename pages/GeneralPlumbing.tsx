    ...
    <div className="w-full font-sans">
       <header className="bg-brand-blue text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-8">Plomería General <br/>en Reynosa</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-heading font-bold text-slate-900 mb-6">Expertos en instalaciones y reparaciones</h2>
              ...
              <div className="space-y-12">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-heading font-bold text-slate-900 mb-3">Reparación de Fugas</h3>
                    <p className="text-slate-600 text-lg mb-4 leading-relaxed">Detectamos y reparamos fugas de agua visibles y ocultas. Evita el desperdicio de agua y facturas altas. Reparamos fugas en:</p>
                    <ul className="list-disc list-inside mt-2 text-slate-600 text-lg ml-2 space-y-2">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-heading font-bold text-slate-900 mb-3">Instalación de Muebles de Baño</h3>
                    <p className="text-slate-600 text-lg mb-4 leading-relaxed">Renueva tu baño con instalación profesional de:</p>
                    <ul className="list-disc list-inside mt-2 text-slate-600 text-lg ml-2 space-y-2">
                      <li>Sanitarios (WC)</li>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-heading font-bold text-slate-900 mb-3">Mantenimiento General</h3>
            ...
            <div className="h-fit sticky top-28 space-y-8">
              ...
              <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200">
                <h3 className="text-xl font-heading font-bold text-slate-900 mb-4">¿Necesitas un plomero?</h3>
      ...
      <section className="bg-slate-900 py-16">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-white">
              <h3 className="text-3xl font-heading font-bold mb-2">¿Tu problema es el drenaje?</h3>
